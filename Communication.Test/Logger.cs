...
{
    public class Logger : ISerilog
    {
        public void Debug(string msg)
        {
        }

        public void Debug<T>(string msgTemplate, T propertyValue)
        {
        ...
        public void Error<T>(string msgTemplate, T propertyValue)
        {
        ...
        public void Fatal<T>(string msgTemplate, T propertyValue)
        {
        ...
        public void Information<T>(string msgTemplate, T propertyValue)
        {
        ...
        public void Verbose<T>(string msgTemplate, T propertyValue)
        {
        ...
        public void Warning<T>(string msgTemplate, T propertyValue)
        {
